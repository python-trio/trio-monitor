...
if [ "$CHECK_FORMATTING" = "1" ]; then
    ...
    if ! yapf -rpd setup.py trio_monitor; then
        cat <<EOF
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
Formatting problems were found (listed above). To fix them, run
   ...
   pip install yapf==${YAPF_VERSION}
   yapf -rpi setup.py trio_monitor
...
if [ "$CHECK_DOCS" = "1" ]; then
    ...
    pytest -W error -ra -v --pyargs trio_monitor --cov=trio_monitor --cov-config=../.coveragerc --verbose
